...
final public class SelectionParamsHolder: ObservableObject {
    ...
    @Published public var liveCameraCell: LiveCameraCellStyle = .none
    ...
    public init(liveCameraCell: LiveCameraCellStyle = .none, mediaType: MediaSelectionType = .photoAndVideo,
                selectionStyle: MediaSelectionStyle = .checkmark, selectionLimit: Int? = nil, showFullscreenPreview: Bool = true) {
